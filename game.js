...
function isWinning(){
 ...
 if (PLAYER_1_POINTS > PLAYER_2_POINTS){
    setTimeout(function (){
      document.getElementById('announceWrap').style.visibility = "visible";
      document.getElementById('announceTitle').innerHTML = "Congratulation!";
      document.getElementById('announceTitle').style.backgroundColor = "#27A042";
      document.getElementById('yourScore').innerHTML = PLAYER_1_POINTS;
      document.getElementById('aiScore').innerHTML = PLAYER_2_POINTS;
      document.getElementById('status').innerHTML = "YOU ARE WIN";
      document.getElementById('status').style.color = "#27A042";
    }, 3000)
    ...
    setTimeout(function(){
      document.getElementById('announceWrap').style.visibility = "visible";
      document.getElementById('announceTitle').innerHTML = "Failed";
      document.getElementById('announceTitle').style.backgroundColor = "#A02727";
      document.getElementById('yourScore').innerHTML = PLAYER_1_POINTS;
      document.getElementById('aiScore').innerHTML = PLAYER_2_POINTS;
      document.getElementById('status').innerHTML = "YOU ARE LOSE";
      document.getElementById('status').style.color = "#A02727";
    }, 3000)
